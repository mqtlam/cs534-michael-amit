...
\section{Learning}
We used two different strategies for learning the best rectangle: 1) AdaBoost with decision stumps and 2) decision trees. The critical question for the decision tree is when to stop growing the tree. We investigate this as a parameter in our experiments.

\section{Experiments}
For AdaBoost, we plot the training and test error as a function of ensemble size.

For the decision tree, we plot the training and test error as a function of the maximum decision tree depth.
